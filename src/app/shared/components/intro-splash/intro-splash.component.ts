...
export class IntroSplashComponent {
  ...
  private runAnimation(gsap: any) {
    ...
    tl.to(this.shineOverlay.nativeElement, { opacity: 1, duration: 0.1 }, 3.2);
    tl.to(this.shineOverlay.nativeElement, { x: '200%', duration: 0.6, ease: 'power2.inOut' }, 3.2);
    tl.to(this.shineOverlay.nativeElement, { opacity: 0, duration: 0.15 }, 3.7);
